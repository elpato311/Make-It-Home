    ...
    <View style={tw`shadow-lg border-2 border-gray-300 m-10 px-3 py-22 items-center bg-white`}>
      <View style={tw`w-full md:w-1/3`}>
        ...
        <Picker style={tw`h-10 border-gray-300	`}
          selectedValue={wallType} onValueChange={value => setWallType(value)}
        >
        ...
        <Picker style={tw`h-10 border-gray-300`}
          selectedValue={products} onValueChange={value => SetProducts(value)}
        >
        ...
        <View style={tw`mt-4 flex-row w-full justify-between`} >
          <Pressable 
          style={tw`w-49% h-8 border items-center justify-center bg-red-400 border-gray-300`}
          >
